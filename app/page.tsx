...
const stripeProducts = [
  {
    ...
    description: '',
    price: '€100/year',
    paymentLink: 'https://buy.stripe.com/00wbJ24sU0iGdyg2lT6wE07',
  },
  {
    id: 2,
    ...
    description: '',
    price: '€200/year',
    paymentLink: 'https://buy.stripe.com/eVq14ogbC2qOfGo8Kh6wE06',
  },
  {
    id: 3,
    ...
    description: '',
    price: '€300/year',
    paymentLink: 'https://buy.stripe.com/bJecN62kM9Tg8dW7Gd6wE05',
  },
  {
    id: 4,
    ...
    description: '',
    price: '€400/year',
    paymentLink: 'https://buy.stripe.com/14A00k4sU7L851K2lT6wE04',
  },
  {
    id: 5,
    ...
    description: '',
    price: '€500/year',
    paymentLink: 'https://buy.stripe.com/fZu14o5wY7L8gKs7Gd6wE03',
  },
  {
    id: 6,
    ...
    description: '',
    price: '€600/year',
    paymentLink: 'https://buy.stripe.com/7sYbJ24sUc1o3XGgcJ6wE02',
  },
  {
    id: 7,
    ...
    description: '',
    price: '€700/year',
    paymentLink: 'https://buy.stripe.com/3cI28se3u4yW79S7Gd6wE01',
  },
  {
    id: 8,
    ...
    description: '',
    price: '€800/year',
    paymentLink: 'https://buy.stripe.com/9B6dRa8JaaXkfGo8Kh6wE00',
  },
];
...
export default function PaymentLinksApp() {
  ...
  const isPhoneNumberValid =
    phoneNumber && phoneNumber.length === 10 && phoneNumber.match(/^\d+$/);
  return (
          ...
          {!emailSent ? (
            ...
            <div className='text-center py-6'>
              ...
              <p className='text-gray-400 text-sm mt-1'>
                Payment link has been sent to {email}
              </p>
            </div>
          )}
        </DialogContent>
            ...
            <div className='space-y-4'>
              <div>
                ...
                <Input
                  ...
                  placeholder='Enter phone number (e.g., 6912345678)'
                  className='mt-1 bg-gray-700 border-gray-600 text-white placeholder-gray-400'
                />
              </div>
              ...
              <div className='flex gap-3'>
                ...
                <Button
                  ...
                  disabled={smsLoading || !isPhoneNumberValid}
                  className='flex-1 bg-orange-500 hover:bg-orange-600 text-white'
                >
